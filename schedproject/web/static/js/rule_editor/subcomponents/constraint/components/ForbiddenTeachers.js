...
export default class ForbiddenTeachers extends BaseConstraint {
    static ID = "FORBIDDEN_TEACHERS";
    ...
    async render() {
        ...
        wrapper.className = "forbidden-teachers-constraint";

        const description = document.createElement("div");
        description.className = "mb-4 text-gray-600";
        description.textContent =
            "Select teachers who will be forbidden from conducting the sessions. Sessions cannot be assigned to these teachers.";
        ...
        validationMsg.textContent =
            "Select at least one teacher who will not be allowed to conduct the sessions.";
