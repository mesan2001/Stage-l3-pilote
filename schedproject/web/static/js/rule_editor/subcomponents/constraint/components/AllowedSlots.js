...
export default class AllowedSlots extends BaseConstraint {
    static ID = "ALLOWED_SLOTS";
    ...
    async beforeRender() {
        ...
        this.containsCatalogConstraint = ["forbidden_slots"];
    }
    ...
    async render() {
        ...
        wrapper.className = "allowed-slots-constraint";
