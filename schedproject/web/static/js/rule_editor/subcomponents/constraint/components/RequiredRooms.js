...
export default class RequiredRooms extends BaseConstraint {
    static ID = "REQUIRED_ROOMS";
    ...
    async render() {
        ...
        wrapper.className = "required-rooms-constraint";

        const description = document.createElement("div");
        description.className = "mb-4 text-gray-600";
        description.textContent =
            "Select rooms that are required for the sessions. Sessions must be scheduled in these rooms.";
        ...
        validationMsg.textContent =
            "Select at least one room that is mandatory for the sessions.";
        wrapper.appendChild(validationMsg);

        this.container.appendChild(wrapper);
    }

    // Helper method to load room data from IDs
