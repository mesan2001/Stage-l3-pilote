...
export default class ForbiddenSlots extends BaseConstraint {
    static ID = "FORBIDDEN_SLOTS";
    ...
    async render() {
        ...
        wrapper.className = "forbidden-slots-constraint";

        const description = document.createElement("div");
        description.className = "mb-4 text-gray-600";
        description.textContent =
            "Select forbidden time slots for sessions using the weekly grid view. Sessions cannot be scheduled during these times.";
        ...
        validationMsg.textContent =
            "Select at least one grid slot where sessions will be forbidden.";
