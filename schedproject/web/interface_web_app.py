...
class InterfacesWebApp:
    ...
    def __init__(
        ...
        # LAST SERVICES
        self.custom_labels_service = CustomLabelsService(self)
        self.labels_service = LabelsService(self)
        self.perimeters_service = PerimetersService(self)
        self.solver_controller_service = SolverControllerService(self)
